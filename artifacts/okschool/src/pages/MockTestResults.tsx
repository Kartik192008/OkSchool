...
export function MockTestResults({ test, questionStates, timeTaken }: MockTestResultsProps) {
  const calculateScore = () => {
    ...
    const totalScore = (correct * marksPerQuestion) - (incorrect * negativeMarks);
    const maxScore = test.questions.length * marksPerQuestion;

    return { correct, incorrect, unattempted, totalScore, maxScore };
  };

  const { correct, incorrect, unattempted, totalScore, maxScore } = calculateScore();
